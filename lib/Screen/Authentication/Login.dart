    ...
    apiBaseHelper.postAPICall(getUserLoginApi, data).then(
      (getdata) async {
        ...
        if (!error) {
          ...
          permission = data[Permission][custPrivacy] ?? "";
          setState(() {
            prefs.setString('customerPermission', "${permission}");
            print("value@@qqqqqqqqqqq $permission");
          });

          var  ok = prefs.getString('customerPermission');
          print("value@@ ${ok}");
          print("value@@qqqqqqqqqqq $permission");
