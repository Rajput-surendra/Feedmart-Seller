...
//============================ AppBar ==========================================
                                ...
                                child: RichText(
                                  text: TextSpan(
                                    children: <TextSpan>[
                                      ...
                                      TextSpan(
                                        text: customPermission == "0" ?
                                          "${capitalize(model.email!.substring(1,3))}....." : capitalize(model.email.toString()),
                                ...
                                child: RichText(
                                  text: TextSpan(
                                    children: <TextSpan>[
                                      ...
                                      TextSpan(
                                        text:
                                         "${capitalize(model.mobile!.substring(1,3))}.....",
                                        recognizer: TapGestureRecognizer()
                                          ..onTap = () {
  ...
  Future<Null> getDetails() async {
    ...
    print("aaaaaaaaaaaa${customPermission}");
    _isNetworkAvail = await isNetworkAvailable();
    if (_isNetworkAvail) {
      try {
        if (notificationisloadmore) {
          ...
          apiBaseHelper.postAPICall(getCustomersApi, parameter).then(
            (getdata) async {
              ...
              print(getCustomersApi.toString());
